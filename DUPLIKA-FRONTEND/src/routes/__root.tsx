...
import { PromoBar, SiteHeader } from "../components/layout/SiteHeader";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "DUPLIKA — Perruques & accessoires capillaires premium" },
      {
        name: "description",
        content:
          "Perruques lace, tissages et accessoires capillaires sélectionnés pièce par pièce. Livraison suivie, conseils d'entretien et retours simples.",
      },
      { name: "author", content: "DUPLIKA" },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "DUPLIKA" },
